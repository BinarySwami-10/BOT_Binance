...
class USD_M:
	...
	otourl='https://www.binance.com/bapi/futures/v1/private/future/strategy/place-order'
...
def test():
	...
	orders=OrderExecutor.generate_orders(SYMBOL,**orderOverrides)
	OrderExecutor.bulk_execute(orders)
	# -------- EXAMPLE --------
	...
	# {'trigPrice': '7.21', 'takeProfit': 7.24, 'stepDeltaRatio': '0.02|0.03', 'Spread': '-0.8%|0.06', 'direction': 'long', 'size': 3.0}
